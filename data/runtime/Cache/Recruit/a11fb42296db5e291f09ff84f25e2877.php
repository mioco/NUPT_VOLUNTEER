...
<div class="wrap J_check_wrap">
	<ul class="nav nav-tabs">
	   ...
	   <li class="active"><a href="<?php echo U('Recruitadmin/not_check');?>" target="_self">未审核</a></li>
	</ul>
	<form class="J_ajaxForm" action="" method="post">
		...
		<table class="table table-hover table-bordered table-list">
			...
			<?php if(is_array($recruit)): foreach($recruit as $key=>$vo): ?><tr>
				...
				<td>
					<a href="<?php echo U('Recruitadmin/delete',array('id'=>$vo['id']));?>" class="J_ajax_del" >删除</a>
				</td>
