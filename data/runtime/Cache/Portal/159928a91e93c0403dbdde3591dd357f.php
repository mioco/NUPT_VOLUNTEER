...
<div class="container new-container">
    <div class="span8">
    <hr>
        <?php $tag = "field:tid,post_author,post_modified,post_title,post_content,post_like,user_number,avatar,comment_count;order:post_date desc;"; $posts = sp_sql_posts_paged_bycatid(1,$tag,16,$pagesetting); ?>
        <?php if(is_array($posts['posts'])): foreach($posts['posts'] as $key=>$vo): $avatar=json_decode($vo['avatar'],true); $path = 'avatar/'.$vo['avatar']; ?>
            <div class="new-box">
                <div class="new-box-up">
                <div class="new-face">
                    <a href="<?php echo leuu('article/index',array('id'=>$vo['tid']));?>">
                        <?php if(empty($vo['avatar'])): ?><img src="/thcmf/tpl/simplebootx/Public/images/default_tupian1.png" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>"/>
                        <?php else: ?> 
                            <img src="<?php echo sp_get_asset_upload_path($path);?>" class="img-responsive img-thumbnail" alt="<?php echo ($vo["post_title"]); ?>" /><?php endif; ?>
                    </a>
                </div>
                <div class="new-detail">
                    <div class="new-name"><a href="<?php echo leuu('article/index',array('id'=>$vo['tid']));?>"><?php echo ($vo["post_title"]); ?></a></div>
                    <div class="new-text"><?php echo ($vo["post_content"]); ?></div>
                    <div class="new-from">来自：<a href="<?php echo leuu('article/index',array('id'=>$vo['tid']));?>"><?php echo ($vo["user_login"]); ?></a>&nbsp;<?php echo ($vo["post_modified"]); ?></div>
                    <ul class="pull-right">
                        <li><a href=""> 评论&nbsp;<?php echo ($vo["comment_count"]); ?></a></li>
                        <li><a href="<?php echo U('article/do_like',array('id'=>$object_id));?>"> <i class="iconfont">&#xe604&nbsp;<?php echo ($vo["post_like"]); ?></i></a></li>
                    </ul>
                    <hr>
                </div>
                </div>
    ...
    <div class="span3">
        <div class="sidebar-notice">
            <div class="siderbar-notice-title"><p>公告栏</p> </div>
